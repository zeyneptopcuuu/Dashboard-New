...
# issuetype adi -> marka anahtari. Yeni bir marka/issuetype eklenirse buraya ekleyin.
ISSUETYPE_BRAND_MAP = {
    "Skechers": "Skechers",
    "Android": "Mobile",
    "iOS": "Mobile",
...
# issuetype'i Bug/Task gibi jenerik olan kayitlar icin, ozet metninde gecen
# anahtar kelimelere gore marka tahmini (kucuk harfe cevrilerek karsilastirilir).
KEYWORD_BRAND_MAP = [
    ("klaud", "Klaud"),
    ("high5", "High5"),
    ("hunter", "Hunter"),
...
# Raporda gosterilecek markalar ve sirasi. Bu listede olmayan markalar (ornegin
# tek bir markaya baglanamayan "Genel" isler) rapora dahil edilmez.
...
def classify(issues):
    ...
    for it in issues:
        ...
        if brand not in BRAND_ORDER:
            continue  # taniyamadigimiz / marka-bagimsiz isler rapora girmiyor
